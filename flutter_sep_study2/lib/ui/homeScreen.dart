...
import 'package:flutter_sep_study2/data/api.dart';
import 'package:flutter_sep_study2/model/kakao_photo.dart';
import 'package:flutter_sep_study2/ui/widget/photo_widget.dart';
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                      onPressed: () async {
                        final kakaoPhotos =
                            await widget.api.fetchPhoto(_controller.text);
                        setState(() {
